...
> 代码：`../../../../Forge/labs/w1/D1-blink/`（sketch.ino + diagram.json）

## 操作步骤（约 10 分钟）

1. 打开 <https://wokwi.com/projects/new/esp32>（免费，无需注册即可跑，登录可保存）
2. 左侧文件树：`sketch.ino` 全部替换为 F 仓 `../../../../Forge/labs/w1/D1-blink/sketch.ino` 的内容
3. 左侧文件树：新建 `diagram.json`，粘贴 F 仓 `../../../../Forge/labs/w1/D1-blink/diagram.json` 内容 → 电路图自动生成

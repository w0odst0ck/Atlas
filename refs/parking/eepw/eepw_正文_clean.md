...
"); //-->
.com.cn/www/delivery/ck.php?n=a4c46fa4&amp;cb=INSERT_RANDOM_NUMBER_HERE" target="_blank"> [![img_01.php](images/img_01.php)] </a>
# 专栏中心
...
.com.cn/www/delivery/ck.php?n=a635e61e&amp;cb=INSERT_RANDOM_NUMBER_HERE" target="_blank"> [[image: img_04.php — manual:图片缺失]] </a>
安科瑞 梅岑彬 18761500144
【摘要】：智能照明控制系统，将普通照明人为的开与关转换成了智能化管理，系统将自动按照预先设定的程序运行。如果需要改变，通过一个按键就可以控制整个停车场内所有的灯光，大大减少了停车场照明的运行维护费用。
【关键词】：智能照明 智能化管理 控制
0\. 前言
随着现代高层建筑的发展，由于经济效益的考虑，也为了使用的方便，地下车库成为现代建筑必不可少的配套建筑之一。由于地下车库的特殊性，面积较大，层高较低，没有或者很少有自然采光等，需要有大量的长期照明设备，在照明设计时应有多方面的斟酌考虑，有设计缺陷的照明系统会影响行车安全、误导行车方向、浪费能源。虽然有的停车场在某些特定区域采用红外或声控开关来控制照明，但是节能效果不很明显。
1\. 系统介绍
安科瑞电气股份有限公司凭借在业内优良的技术优势和丰富的实际工程应用经验，将科技、高品质和人性化的设计注入每个产品，面向地下停车场推出：ALIBUS总线地下停车场智能照明控制系统，它通过先进的ALIBUS总线控制技术，能够实现对地下停车场的灯光进行智能化管理与控制，从而达到良好的节能效果、合理地延长灯具的寿命、管理维护非常方便、优化工作环境和提高工作效率、为地下停车场的管理带来较高的经济回报率。该系统是在社会和酒店发展的战略高度，为提高地下停车场的档次、管理水平、节能减排、精简人员、节省运营成本和提高服务质量，而提供的一套完整信息化建设及智能控制的系统性解决方案。
2.项目需求
由于地下停车库的位置特点所限，自然采光比较差，因此照明问题问题往往是客户关注的焦点，主要表现在以下几个方面：
1、 一般车库照明需要7*24小时不间断照明，一年总计电费相当可观
2、 车库照明灯具数量相当对，维护工作量大，灯具更换成本高；
3、 传统照明控制方式比较单一，灯具的开、关比较麻烦
4、 有些客户为了节约照明成本，会采用减少照明路数的方式达到节约电费的目的，但同时又会导致车库照度降低，影响监控效果，提升停车风险等一系列安全问题，增加管理难度。
根据停车场项目实施的经验，我们对于这种项目的需求分析如下：
（1） 通过智能照明控制系统能节省非常庞大的能源消耗
（2） 能够对地下停车场内所有灯光实施监控
（3） 地下停车场的灯具数量多，品质高，通过智能照明系统可延长灯具的寿命，降低停车场运行费用。
3、项目设计原则
智能照明控制系统设计遵循技术先进、功能齐全、性能稳定、时尚创新的原则，并综合考虑施工、维护及操作因素，并将为今后的发展、扩建、改造等因素留有扩充的余地。智能照明控制系统设计方案具有科学性、合理性、可操作性。其具有以下原则：
1） 先进性与适用性
系统的技术性能和质量指标达到国内优良水平的同时，确保系统的安装调试、软件编程和操作使用的简便易行、容易掌握，并具有适合本项目的特点，智能控制系统网络技术适应时代发展的要求，同时系统可面向各种管理层次使用。我们的系统功能的配置以给用户提供安全、方便、快捷为准则，操作简便易学。
2） 实用性
本系统充分考虑了用户的实际需要和信息技术发展的趋势，根据用户现场环境，设计适合现场情况，符合用户需求的系统配置方案，通过严密组合，实现良好的性能，保证系统能实施的需求。
3） 可靠性与安全性
在设计中体现高起点、高质量、高可靠性的原则设计，在系统故障或事故造成系统瘫痪后能确保数据的准确性、完整性、和一致性。并具备迅速恢复的功能，同时系统具有一整套完整的管理策略可以保证系统的安全运行。
4） 开放性与标准性
开放、标准化的技术使得建筑内空调、通风及照明等设备都能方便地被集成到一个平台，这将大大减少人员培训和设备维护成本，提高能源利用率，并可通过采集和共享大量实时设备运行和资金消耗数据，提供增值服务。
5） 可扩充性
系统设计考虑到今后技术的发展和使用的需要，具有更新、扩充和升级的可能，并根据今后项目工程的实际要求扩展系统功能，同时在方案设计中留有冗余，以满足用户今后发展的需求
6） 追求更优化的系统设备配置
在满足用户对于功能、质量、价格和服务等各方面的要求的前提下，我们住
4、产品介绍
根据项目需求，我司选用以下产品帮助客户更好实现地下停车场智能照明系统管理，达到节能减排，减少不必要照明费用的支出。
4.1 开关驱动器
ASL200系列开关驱动器(以下简称模块)，是安科瑞ALIBUS智能照明控制系统的控制模块。该模块和其他模块（诸如智能面板、传感器等）连接到一起，组成一套完整的控制系统，实现大型公建、楼宇照明系统的智能控制。
该整机作为驱动模块，直接控制负载电源的通断,实现多种控制功能，如：开关功能、电流检测、故障报警、延时功能、场景控制、阈值功能等。
...
输入电压| 220V±10%  
遥控输出| 继电器带拨杆、额定电流16A  
测量精度| 频率0.05Hz，电压、电流精度0.5级，电能精度1级  
开关量输入| 两路无源干接点输入方式:内置电源  
开关量输出| 两路无源常开触点，触点容量AC 220V/1A ，DC 30V/1A  
通讯| ALIBUS；Modbus-RTU协议  
安装方式| 35mm导轨式安装  
使用环境| 工作温度：-10℃~+55℃；相对湿度：≤95%不结露  
储存温度范围| -20℃~+70℃  
显示| LCD液晶显示  
4.2 传感器
...
4.3 智能照明监控软件系统主要控制功能 
  

4.3.1 定时控制
利用中控软件界面时钟管理器，实现整个系统的有关区域照明的定时和自动管理功能，实现公共通道、景观照明、车库照明等定时、分时控制、用户可按需设定平时照明、高峰照明、节假日模式定时关闭、定时通知等。
4.3.2 场景控制
智能照明控制系统根据各个部门的需求，设定不同种类的场景模式，进行各种照明灯光的组合，柔和工作环境的效果；结合人体感应传感器，当人员离开时，关闭该区域照明。
4.3.3 实时监控
...
4.3.6 数据交换
系统支持OPC服务；通过系统软件可以与其他建筑智能化系统（如BA系统）进行数据交换。
4.3.7 系统联动
...
（1） 定时任务界面：可供客户自由选择每个定时任务中执行的任务及对应的状态
[![img_10.png](images/img_10.png)] 
（2） 控制界面：可按照区-楼-层的拓扑结构将各个控件分布到界面上，方便客户进行操作
[![img_11.png](images/img_11.png)] 
（3） 模块状态一目了然，如果有模块掉线的情况会在界面上提示客户及时排查模块掉线情况
[![img_12.png](images/img_12.png)] 
（4）各个事件均有记录，能够方便后续的检修
5．结束语
智能照明控制系统，将普通照明人为的开与关转换成了智能化管理，系统将自动按照预先设定的程序运行。如果需要改变，通过一个按键就可以控制整个区域内所有的灯光，大大减少了的照明维护费用。
  

专栏文章内容及配图由作者撰写发布，仅供工程师学习之用，如有侵权或者其他违规问题，请联系本站处理。 [联系我们](<https://www.eepw.com.cn/event/company/contact.html>)
.com.cn/www/delivery/ck.php?n=ae6854a5&amp;cb=INSERT_RANDOM_NUMBER_HERE" target="_blank"> [[image: img_13.php — manual:图片缺失]] </a>
关键词： _智能照明系统_
### 相关推荐
[ [[image: img_14.jpg — manual:图片缺失]] ](<https://www.eepw.com.cn/circuit/201412/121807.html>)
...
[光电显示](<https://www.eepw.com.cn/info/industry/special/led>) [智能照明系统](<https://www.eepw.com.cn/tech/s/k/%E6%99%BA%E8%83%BD%E7%85%A7%E6%98%8E%E7%B3%BB%E7%BB%9F>) [](<https://www.eepw.com.cn/tech/s/k/>) 2012-10-29
  * [上一篇：信号隔离器在锅炉控制系统中的应用](<https://www.eepw.com.cn/zhuanlan/202306/311771.html> "信号隔离器在锅炉控制系统中的应用")
  * [下一篇：基于工业物联网的社区水电设备一体化监测系统](<https://www.eepw.com.cn/zhuanlan/202306/311762.html> "基于工业物联网的社区水电设备一体化监测系统")


.com.cn/www/delivery/ck.php?n=a674caa6&amp;cb=INSERT_RANDOM_NUMBER_HERE" target="_blank"> [[image: img_15.php — manual:图片缺失]] </a>
[更多](<http://seminar.eepw.com.cn>) **培训课堂**
[更多](<https://www.eepw.com.cn/news>) **焦点**
.com.cn/www/delivery/ck.php?n=a50e4511&amp;cb=INSERT_RANDOM_NUMBER_HERE" target="_blank"> [[image: img_16.php — manual:图片缺失]] </a>
[更多](<http://v.eepw.com.cn>) **视频**
.com.cn/www/delivery/ck.php?n=aaeb3436&amp;cb=INSERT_RANDOM_NUMBER_HERE" target="_blank"> [![img_17.php](images/img_17.php)] </a>
## 技术专区
